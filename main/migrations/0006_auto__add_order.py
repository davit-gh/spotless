...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_order', (
            ...
            ('type_of_service', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('date_time', self.gf('django.db.models.fields.DateField')(max_length=50)),
            ('frequency_of_service', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('payment_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
