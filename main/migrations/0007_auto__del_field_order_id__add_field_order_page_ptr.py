...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'main_order', u'id')

        # Adding field 'Order.page_ptr'
        db.add_column(u'main_order', u'page_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['pages.Page'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Order.id'
        db.add_column(u'main_order', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)

        # Deleting field 'Order.page_ptr'
        db.delete_column(u'main_order', u'page_ptr_id')
    ...
    models = {
        ...
        u'main.order': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'Order', '_ormbases': [u'pages.Page']},
