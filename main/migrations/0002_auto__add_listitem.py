...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_listitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('_order', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('list_item', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'main', ['ListItem'])


    def backwards(self, orm):
        # Deleting model 'ListItem'
        db.delete_table(u'main_listitem')
    ...
    models = {
        ...
        u'main.listitem': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'ListItem'},
            '_order': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'list_item': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        u'main.portfolio': {
