...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TableCell.content'
        db.delete_column(u'main_tablecell', 'content')

        # Deleting field 'TableCell.id'
        db.delete_column(u'main_tablecell', u'id')

        # Adding field 'TableCell.page_ptr'
        db.add_column(u'main_tablecell', u'page_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['pages.Page'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TableCell.content'
        db.add_column(u'main_tablecell', 'content',
                      self.gf('mezzanine.core.fields.RichTextField')(default=1),
                      keep_default=False)

        # Adding field 'TableCell.id'
        db.add_column(u'main_tablecell', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)

        # Deleting field 'TableCell.page_ptr'
        db.delete_column(u'main_tablecell', u'page_ptr_id')
