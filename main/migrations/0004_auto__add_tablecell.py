...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_tablecell', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content', self.gf('mezzanine.core.fields.RichTextField')()),
            ('row1', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('row2', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('row3', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('row4', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('row5', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('row6', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('row7', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'main', ['TableCell'])


    def backwards(self, orm):
        # Deleting model 'TableCell'
        db.delete_table(u'main_tablecell')
